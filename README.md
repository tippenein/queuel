...
Notes:
A config should be added to provide `bucket_name`, `max_bytesize`, `access_key` and `secret_access_key`. Without these, messages over the max_bytesize will be dropped from the queue.
